...
if __name__ == "__main__":
    ...
    pd.to_pickle(wav_fs.description,"/nfs/guille/eecs_research/soundbendor/datasets/sounds_and_noise/wavcaps/misc/audiocommons_duplicates_dropped_descriptions.pickle")